...
__global__ void edgeDetection(int *d_width, int *d_height, unsigned char *d_input, unsigned char *d_output){
...
int main (int argc, char *argv[]){
    ...
    edgeDetection<<<gridD, blockD>>>(d_width, d_height, d_input, d_output);
